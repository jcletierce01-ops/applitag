...
export const BigBtn = ({onClick,bg=C.green,color="#fff",children,disabled,icon,style={}}) => (
...
export const MInput = ({label,value,onChange,placeholder,type="text",required,error,hint,big,min}) => {
...
export const GridSelect = ({options,value,onChange,cols=3}) => (
...
export const SectionTitle = ({icon,label,color}) => (
...
export const MiniBarChart = ({data, color=C.green, height=40}) => {
...
export const MSlider = ({label,value,onChange,min,max,step=1,unit,color=C.green,hint}) => (
  <div style={{marginBottom:14}}>
...
export const CheckItem = ({checked,onChange,label,sub,warn}) => (
