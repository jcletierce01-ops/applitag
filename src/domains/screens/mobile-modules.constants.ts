...
export const GROUPES_MODULES: { label: string; items: ModuleDef[] }[] = [
  ...
  { label:"💼 Gestion & Commerce", items:[
    ...
    { id:"rapports",     icon:"📋", label:"Rapports",        flag:"RAPPORTS",     nav:"saisies" },
    { id:"analyses",     icon:"📈", label:"Analyses",        flag:"ANALYSES",     nav:"saisies" },
  ]},
  { label:"⚙️ Admin & Réseau", items:[
    { id:"alertes",      icon:"🔔", label:"Alertes",         flag:"ALERTES",      nav:"alertes" },
    { id:"utilisateurs", icon:"👥", label:"Utilisateurs",    flag:"UTILISATEURS", nav:"profil" },
    ...
    { id:"parametres",   icon:"⚙️", label:"Paramètres",      flag:"PARAMETRES",   nav:"profil" },
  ]},
];
